...
namespace MakaleApp.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<MakaleRepository>();
            services.AddScoped<KategoriRepository>();
            services.AddScoped<YorumRepository>();


            services.AddDbContext<MakaleDbContext>(options =>
                options.UseSqlServer(
                    Configuration.GetConnectionString("MakaleConnection")));
